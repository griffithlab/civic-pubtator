...
MAX_STEP_SIZE=$2
MODEL=$3
OPT="--entityTypes Chemical"
OPT="${OPT} --lexiconNamespaces MESH" 
OPT="${OPT} --trainingDatasetConfig ncbi.taggerOne.dataset.PubtatorDataset|data/BC5CDR/CDR.2.PubTator|data/BC5CDR/BC5CDR_traindev_PMIDs.txt|Chemical->Chemical,Disease->Disease|Chemical->Identify,Disease->Ignore|MESH"
OPT="${OPT} --holdoutDatasetConfig ncbi.taggerOne.dataset.PubtatorDataset|data/BC5CDR/CDR.2.PubTator|data/BC5CDR/BC5CDR_sample_PMIDs.txt|Chemical->Chemical,Disease->Disease|Chemical->Identify,Disease->Ignore|MESH"
OPT="${OPT} --lexiconConfig ncbi.taggerOne.lexicon.loader.CTDChemicalLexiconMappingsLoader|Chemical|data/BC5CDR/CTD_chemicals-2015-07-22.tsv"
OPT="${OPT} --lexiconConfig ncbi.taggerOne.lexicon.loader.ElementsLoader|Chemical|data/BC5CDR/elements.tsv"
OPT="${OPT} --abbreviationSource ncbi.taggerOne.abbreviation.FileAbbreviationSource|data/BC5CDR/abbreviations.tsv"
OPT="${OPT} --entityTokenizerClass ncbi.taggerOne.util.tokenization.FinerTokenizer"
OPT="${OPT} --textInstanceTokenizerClass ncbi.taggerOne.util.tokenization.FinerTokenizer"
OPT="${OPT} --stemmerClass ncbi.taggerOne.processing.string.PluralStemmer"
