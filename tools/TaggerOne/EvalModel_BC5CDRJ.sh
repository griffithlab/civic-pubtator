...
MODEL=$1
OPT="--evaluationDatasetConfig ncbi.taggerOne.dataset.PubtatorDataset|data/BC5CDR_TEST/CDR_TestSet.PubTator.joint.txt|data/BC5CDR_TEST/CDR_TestSet.pmids.txt|Chemical->Chemical,Disease->Disease|Chemical->Identify,Disease->Identify|MESH"
