...
MAX_STEP_SIZE=$2
MODEL=$3
OPT="--entityTypes Chemical|Disease"
OPT="${OPT} --lexiconNamespaces MESH|OMIM" 
OPT="${OPT} --trainingDatasetConfig ncbi.taggerOne.dataset.PubtatorDataset|data/BC5CDR/CDR.2.PubTator|data/BC5CDR/BC5CDR_traindev_PMIDs.txt|Chemical->Chemical,Disease->Disease|Chemical->Identify,Disease->Identify|MESH"
OPT="${OPT} --holdoutDatasetConfig ncbi.taggerOne.dataset.PubtatorDataset|data/BC5CDR/CDR.2.PubTator|data/BC5CDR/BC5CDR_sample_PMIDs.txt|Chemical->Chemical,Disease->Disease|Chemical->Identify,Disease->Identify|MESH"
