...
from src_python.AIONER.processing_data import ml_intext_fn,out_BIO_BERT_crf_fn,out_BIO_BERT_softmax_fn
...
nlp = stanza.Pipeline(model_dir='AIONER_trained_models/stanza', lang='en', processors={'tokenize': 'spacy'},package='None', download_method=None) #package='craft' ;./gnorm_trained_models/stanza
    ...
    if files_exsited==0:
        ...
        if para_set['encoder_type']=='pubmedbert':
            vocabfiles={'labelfile':'./vocab/AIO_label.vocab',
                        'checkpoint_path':'./AIONER_trained_models/BiomedNLP-PubMedBERT-base-uncased-abstract/',
                        'lowercase':True,
                        } 
        elif para_set['encoder_type']=='bioformer':
            vocabfiles={'labelfile':'./vocab/AIO_label.vocab',
                        'checkpoint_path':'./AIONER_trained_models/bioformer-cased-v1.0/',
                        'lowercase':False,
                        }    
