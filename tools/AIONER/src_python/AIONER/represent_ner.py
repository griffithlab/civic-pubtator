...
class Hugface_RepresentationLayer(object):
    ...
    def __init__(self, tokenizer_name_or_path, label_file,lowercase=True):
        ...
        #self.tokenizer.add_tokens(["<ChemicalEntity>","</ChemicalEntity>","<DiseaseOrPhenotypicFeature>","</DiseaseOrPhenotypicFeature>","<CellLine>","</CellLine>","<GeneOrGeneProduct>","</GeneOrGeneProduct>","<OrganismTaxon>","</OrganismTaxon>","<SequenceVariant>","</SequenceVariant>","<ALL>","</ALL>"])

        self.tokenizer.add_tokens(["<Chemical>","</Chemical>","<Disease>","</Disease>","<CellLine>","</CellLine>","<Gene>","</Gene>","<Species>","</Species>","<Mutation>","</Mutation>","<ALL>","</ALL>"])
        #load label
        self.label_2_index={}
        self.index_2_label={}
