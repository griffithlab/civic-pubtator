...
from src_python.AIONER.processing_data import ml_intext,out_BIO_BERT_softmax,out_BIO_BERT_crf
from src_python.AIONER.evaluation_BIO import NER_Evaluation_fn
...
if __name__=="__main__":
    ...
    parser.add_argument('--trainfile', '-t', help="the training set file",default='./data/AIONER/Train_tmvar3-AIO.conversion.conll')
