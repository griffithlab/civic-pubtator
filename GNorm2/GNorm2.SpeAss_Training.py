...
import argparse
import random
from src_python.SpeAss.model_sa import HUGFACE_NER
from src_python.SpeAss.processing_data_sa import ml_intext,out_BIO_BERT_softmax
from src_python.SpeAss.Evaluation_sa import Rel_Evaluation_Hugface_fn
...
if __name__=="__main__":
    ...
    parser.add_argument('--trainfile', '-t', help="the training set file",default='./TrainingSet/SA.Train.conll')
