    ...
    for doc_text in all_in:
        ...
        if entity_all!=[]:
            ...
            for entity_i in range(0,len(entity_all)):
                entity_start = int(entity_all[entity_i][3])
                entity_end = int(entity_all[entity_i][4]) - 1
                if entity_start < len(index_map) and index_map[entity_start] != -1 and entity_end < len(index_map) and index_map[entity_end] != -1:
