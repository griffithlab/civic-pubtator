...
entities_filenames.append("extracted/entities_BioMappings.json.gz")
entities_filenames.append("/net/intdev/lulab/leamanjr/data/PubChem/entities_PubChem.json.gz")

id2ids_filename=None
...
def main():
	...
	global id2ids_filename
	target_resources = set(sys.argv[1].split(","))
	mappings_filename = sys.argv[2]
	id2ids_filename = sys.argv[3]
	print("target_resources = {}".format(target_resources))
	print("mappings_filename = {}".format(mappings_filename))
	print("id2ids_filename = {}".format(id2ids_filename))
